...
RUN apk --no-cache upgrade && \
    apk --no-cache add bash git sudo openssh sqlite sqlite-dev libxml2-dev oniguruma-dev autoconf gcc g++ make npm freetype-dev libjpeg-turbo-dev libpng-dev libzip-dev ssmtp
